...
public class TickDeltaMixin {
    ...
    @WrapOperation(method = "getTickDelta", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/Minecraft;getFrameTime()F"))
    private static float wrapPartialTick(Minecraft instance, Operation<Float> original) {
        ...
        return TimeScaleHandler.isEntityScalableFrozen(entity)
                ? TimeScaleHandler.getScalablePartialTick(entityRunsNormally)
